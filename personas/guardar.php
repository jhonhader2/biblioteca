...
if (!isset($_POST['id'])) {
    $query = "INSERT INTO personas(primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, biografia, email, id_rol) VALUES('$primer_nombre', '$segundo_nombre', '$primer_apellido', '$segundo_apellido', '$biografia', '$email', '$id_rol')";
} else {
